<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Admin-InsertCallOfDuty.aspx.cs" Inherits="Admin_InsertCallOfDuty" %>
        ...
        <div class="insertcontainer">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox Style="width: 20%; height: 30px; border: 0.5px solid" ID="txtCallOfDutyID" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtCallOfDutyName" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtCallOfDutyPublisher" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox Style="width: 30%; height: 30px; border: 0.5px solid" ID="txtCallOfDutyPrice" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtCallOfDutyGenre" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox Style="width: 100%; height: 80px; border: 0.5px solid" ID="txtCallOfDutyDesc" runat="server" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
