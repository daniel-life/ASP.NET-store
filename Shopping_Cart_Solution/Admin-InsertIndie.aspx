<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Admin-InsertIndie.aspx.cs" Inherits="Admin_InsertIndie" %>
        ...
        <div class="insertcontainer">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox Style="width: 20%; height: 30px; border: 0.5px solid" ID="txtIndieID" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtIndieName" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtIndiePublisher" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox Style="width: 30%; height: 30px; border: 0.5px solid" ID="txtIndiePrice" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtIndieGenre" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox Style="width: 100%; height: 80px; border: 0.5px solid" ID="txtIndieDesc" runat="server" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
