<%@ Page Title="" Language="C#" MasterPageFile="~/GameMaster.master" AutoEventWireup="true" CodeFile="GameBestseller.aspx.cs" Inherits="GameBestseller" %>
                    ...
                    <asp:Repeater ID="CallOfDuty" runat="server">
                         <ItemTemplate>             
                             <div style="width: 146px">
                                <asp:ImageButton PostBackUrl='<%# ResolveClientUrl("ProductDetails?ProdID=" + Eval("GS_ID"))%>' ID="imgGames"  CssClass="gameimage" ImageUrl='<%#Eval("GS_Image")%>' runat="server" />
                                <asp:Label CssClass="gametitle" ID="lblTitle"  runat="server" Text='<%#Eval("GS_Title")%>'></asp:Label>
                                <br />
                                <asp:Label CssClass="gamedeveloper" ID="lblDeveloper" runat="server" Text='<%#Eval("GS_Publisher")%>' Style="color: #48C9B0"></asp:Label>
                            </div>
